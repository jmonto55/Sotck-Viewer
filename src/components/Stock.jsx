  ...
  return (
    <div className="flex w-screen max-w-screen-2xl h-screen relative">
      <div className="m-auto w-3/4 h-3/4 flex">
        ...
        <div className="pt-5 text-center flex flex-col items-center justify-evenly z-20 p-5 m-auto h-5/6 w-5/6 min-w-full bg-white bg-opacity-10 text-white rounded-2xl shadow-5xl border-2 border-b-0 border-r-0 border-white/25 backdrop-filter backdrop-blur-sm">
