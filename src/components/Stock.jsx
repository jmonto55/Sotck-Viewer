  ...
  return (
    <div className="flex w-screen max-w-screen-2xl h-screen relative">
      <div className="m-auto w-3/4 h-3/4 flex">
        <div className="animate-pulse-mid z-10 h-80 w-80 md:h-96 md:w-96 bg-gradient-to-r from-neutral-700 to-neutral-900 rounded-full absolute right-20 top-0" />
        ...
        <div className="animate-pulse-mid z-10 h-80 w-80 md:h-96 md:w-96 bg-gradient-to-r from-neutral-900 to-neutral-700 rounded-full absolute left-20 bottom-6" />
      </div>
    </div>
  );
};
